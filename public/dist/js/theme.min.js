window.hs_config={autopath:"@@autopath",deleteLine:"hs-builder:delete","deleteLine:build":"hs-builder:build-delete","deleteLine:dist":"hs-builder:dist-delete",previewMode:!1,startPath:"/index.html",vars:{themeFont:"https://fonts.googleapis.com/css2?family=Inter:wght@400;600&display=swap",version:"?v=1.0"},layoutBuilder:{extend:{switcherSupport:!0},header:{layoutMode:"default",containerMode:"container-fluid"},sidebarLayout:"default"},themeAppearance:{layoutSkin:"default",sidebarSkin:"default",styles:{colors:{primary:"#377dff",transparent:"transparent",white:"#fff",dark:"132144",gray:{100:"#f9fafc",900:"#1e2022"}},font:"Inter"}},languageDirection:{lang:"en"},skipFilesFromBundle:{dist:["assets/js/hs.theme-appearance.js","assets/js/hs.theme-appearance-charts.js","assets/js/demo.js"],build:["assets/css/theme.css","assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js","assets/js/demo.js","assets/css/theme-dark.css","assets/css/docs.css","assets/vendor/icon-set/style.css","assets/js/hs.theme-appearance.js","assets/js/hs.theme-appearance-charts.js","node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js"]},minifyCSSFiles:["assets/css/theme.css","assets/css/theme-dark.css"],copyDependencies:{dist:{"*assets/js/theme-custom.js":""},build:{"*assets/js/theme-custom.js":"","node_modules/bootstrap-icons/font/*fonts/**":"assets/css"}},buildFolder:"",replacePathsToCDN:{},directoryNames:{src:"./resources/assets",dist:"./public",build:"./public/build"},fileNames:{dist:{js:"theme.min.js",css:"theme.min.css"},build:{css:"theme.min.css",js:"theme.min.js",vendorCSS:"vendor.min.css",vendorJS:"vendor.min.js"}},fileTypes:"jpg|png|svg|mp4|webm|ogv|json"},window.hs_config.gulpRGBA=t=>{const e=t.split(","),i=e[0].toString(),o=e[1].toString();var n;if(/^#([A-Fa-f0-9]{3}){1,2}$/.test(i))return 3==(n=i.substring(1).split("")).length&&(n=[n[0],n[0],n[1],n[1],n[2],n[2]]),"rgba("+[(n="0x"+n.join(""))>>16&255,n>>8&255,255&n].join(",")+","+o+")";throw new Error("Bad Hex")},window.hs_config.gulpDarken=t=>{const e=t.split(",");let i=e[0].toString(),o=-parseInt(e[1]);var n=!1;"#"==i[0]&&(i=i.slice(1),n=!0);var l=parseInt(i,16),s=(l>>16)+o;s>255?s=255:s<0&&(s=0);var a=(l>>8&255)+o;a>255?a=255:a<0&&(a=0);var r=(255&l)+o;return r>255?r=255:r<0&&(r=0),(n?"#":"")+(r|a<<8|s<<16).toString(16)},window.hs_config.gulpLighten=t=>{const e=t.split(",");let i=e[0].toString(),o=parseInt(e[1]);var n=!1;"#"==i[0]&&(i=i.slice(1),n=!0);var l=parseInt(i,16),s=(l>>16)+o;s>255?s=255:s<0&&(s=0);var a=(l>>8&255)+o;a>255?a=255:a<0&&(a=0);var r=(255&l)+o;return r>255?r=255:r<0&&(r=0),(n?"#":"")+(r|a<<8|s<<16).toString(16)},window.updateMetaThemeColor=function(){const t=document.getElementById("theme-color-meta");t&&"undefined"!=typeof HSThemeAppearance&&("dark"===HSThemeAppearance.getAppearance()?t.setAttribute("content","#1e2022"):t.setAttribute("content","#ffffff"))},window.onload=function(){"undefined"!=typeof HSSideNav&&document.querySelector(".js-navbar-vertical-aside")&&new HSSideNav(".js-navbar-vertical-aside").init(),"undefined"!=typeof HSFormSearch&&document.querySelector(".js-form-search")&&new HSFormSearch(".js-form-search"),void 0!==HSBsDropdown&&HSBsDropdown.init(),"function"==typeof initThemeDropdown&&initThemeDropdown(),updateMetaThemeColor()},window.initThemeDropdown=function(){const t=document.getElementById("selectThemeDropdown");if(!t||"undefined"==typeof HSThemeAppearance)return!!t&&(setTimeout(initThemeDropdown,100),!1);const e=document.querySelectorAll('[aria-labelledby="selectThemeDropdown"] [data-icon]');if(!e.length)return!1;const i=function(){const i=HSThemeAppearance.getOriginalAppearance()||"default";e.forEach(e=>{if(e.getAttribute("data-value")===i){const i=e.getAttribute("data-icon");i&&t&&(t.innerHTML=`<i class="${i}"></i>`),e.classList.add("active")}else e.classList.remove("active")})};return e.forEach(t=>{t.hasAttribute("data-theme-listener")||(t.setAttribute("data-theme-listener","true"),t.addEventListener("click",e=>{e.preventDefault();const i=t.getAttribute("data-value");i&&HSThemeAppearance.setAppearance(i)}))}),i(),window.addEventListener("on-hs-appearance-change",i),!0},window.addEventListener("on-hs-appearance-change",function(){"function"==typeof updateMetaThemeColor&&updateMetaThemeColor()});const HSCore={components:{},collection:{tooltips:[],popovers:[]},init:function(){const t=this,e=document.querySelectorAll('[data-bs-toggle="tooltip"]');for(let i=0;i<e.length;i+=1)t.collection.tooltips.push(new bootstrap.Tooltip(e[i]));const i=document.querySelectorAll('[data-bs-toggle="popover"]');for(let e=0;e<i.length;e+=1)t.collection.popovers.push(new bootstrap.Popover(i[e]));document.querySelectorAll("[data-bs-popover-dark]").forEach(function(t){t.addEventListener("click",function(t){const e=document.querySelectorAll(".popover");e.length&&e[e.length-1].classList.add("popover-dark")})})},getTooltips:function(){return this.collection.tooltips},hideTooltips:function(){const t=this.getTooltips();for(let e=0;e<t.length;e+=1)t[e].hide()},getPopovers:function(){return this.collection.popovers},hidePopovers:function(){const t=this.getPopovers();for(let e=0;e<t.length;e+=1)t[e].hide()},disposePopovers:function(){const t=this.getPopovers();for(let e=0;e<t.length;e+=1)t[e].dispose()}};HSCore.init();const HSBsDropdown={init(t){this.setAnimations(),this.openOnHover()},scrollEvent:null,setAnimations(){window.addEventListener("show.bs.dropdown",t=>{const e=t.target.closest(".table-responsive");if(e&&(this.scrollEvent=function(){new bootstrap.Dropdown(t.target).hide()},e.addEventListener("scroll",this.scrollEvent)),!t.target.hasAttribute("data-bs-dropdown-animation"))return;const i=t.target.nextElementSibling;i.style.opacity=0,setTimeout(()=>{i.style.transform=`${i.style.transform} translateY(10px)`}),setTimeout(()=>{i.style.transform=`${i.style.transform} translateY(-10px)`,i.style.transition="transform 300ms, opacity 300ms",i.style.opacity=1},100)}),window.addEventListener("hide.bs.dropdown",t=>{const e=t.target.closest(".table-responsive");if(e&&e.removeEventListener("scroll",this.scrollEvent),!t.target.hasAttribute("data-bs-dropdown-animation"))return;const i=t.target.nextElementSibling;setTimeout(()=>{i.style.removeProperty("transform"),i.style.removeProperty("transition")})})},openOnHover(){Array.from(document.querySelectorAll("[data-bs-open-on-hover]")).forEach(t=>{var e;const i=new bootstrap.Dropdown(t);function o(){e=setTimeout(()=>{i.hide()},500)}t.addEventListener("mouseenter",()=>{clearTimeout(e),i.show()}),i._menu.addEventListener("mouseenter",()=>{window.clearTimeout(e)}),Array.from([i._menu,t]).forEach(t=>t.addEventListener("mouseleave",o))})}},validators={"data-hs-validation-equal-field":t=>{const e=document.querySelector(t.getAttribute("data-hs-validation-equal-field"));t.addEventListener("input",i=>{e.value.toString().toLocaleLowerCase()!==i.target.value.toString().toLocaleLowerCase()?t.setCustomValidity("qual-field"):t.setCustomValidity(""),HSBsValidation.updateFieldStete(t)}),e.addEventListener("input",e=>{t.value.toString().toLocaleLowerCase()!==e.target.value.toString().toLocaleLowerCase()?t.setCustomValidity("qual-field"):t.setCustomValidity(""),HSBsValidation.updateFieldStete(t)})}},HSBsValidation={init(t,e){var i=document.querySelectorAll(t);return Array.prototype.slice.call(i).forEach(t=>{for(const e in validators)Array.prototype.slice.call(t.querySelectorAll(`[${e}]`)).forEach(validators[e]);this.addVlidationListners(t.elements),t.addEventListener("submit",i=>{t.checkValidity()?this.onSubmit({event:i,form:t,options:e}):(i.preventDefault(),i.stopPropagation(),this.checkFieldsState(t.elements)),t.classList.add("was-validated")},!1)}),this},addVlidationListners(t){Array.prototype.slice.call(t).forEach(t=>{const e=t.closest("[data-hs-validation-validate-class]");e&&(t.addEventListener("input",t=>this.updateFieldStete(t.target)),t.addEventListener("focus",t=>e.classList.add("focus")),t.addEventListener("blur",t=>e.classList.remove("focus")))})},checkFieldsState(t){Array.prototype.slice.call(t).forEach(t=>this.updateFieldStete(t))},updateFieldStete(t){const e=t.closest("[data-hs-validation-validate-class]");e&&(t.checkValidity()?(e.classList.add("is-valid"),e.classList.remove("is-invalid")):(e.classList.add("is-invalid"),e.classList.remove("is-valid")))},onSubmit:t=>!(!t.options||"function"!=typeof t.options.onSubmit)&&t.options.onSubmit(t)}
/*
* Chart.js wrapper
