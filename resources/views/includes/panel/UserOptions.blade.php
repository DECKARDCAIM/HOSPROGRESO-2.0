    ...
    <div class="navbar-nav-wrap">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="dropdown">
                        <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle"
                            ...
                            <i class="bi-bell"></i>
                            @if ($latestComunicados->count() + $latestActualizaciones->count() > 0)
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        class="avatar avatar-sm avatar-soft-primary avatar-circle">
                                                                        <span
                                                            ...
                                                            <small
                                                                class="col-auto text-muted text-cap">{{ $rel->published_at->diffForHumans() }}</small>
                                                        </div>
                                                        <a class="stretched-link"
                                                            href="{{ route('releases.show', $rel->id) }}"></a>
                                                    </li>
                                                @empty
                                                        ...
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div
                                                                        class="avatar avatar-sm avatar-soft-info avatar-circle">
                                                                        <span
                                                            ...
                                                            <small
                                                                class="col-auto text-muted text-cap">{{ $act->published_at->diffForHumans() }}</small>
                                                        </div>
                                                        <a class="stretched-link"
                                                            href="{{ route('releases.show', $act->id) }}"></a>
                                                    </li>
                                                @empty
                                                    <li class="list-group-item">
                                                        <div class="text-center p-4">
                        ...
                        <div class="card-body card-body-height">
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img class="avatar avatar-xs avatar-4x3"
                                            src="{{ asset('svg/brands/slack-icon.svg') }}" alt="Image Description">
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-3">
        ...
        <li class="nav-item">
            <button class="btn btn-ghost-secondary btn-icon rounded-circle" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#offcanvasChatISAAC" aria-controls="offcanvasChatISAAC">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account bg-white"
                    ...
                    <div class="dropdown">
                        <a class="navbar-dropdown-submenu-item dropdown-item dropdown-toggle" href="javascript:;"
                            id="navSubmenuPagesAccountDropdown1" data-bs-toggle="dropdown">
                            Estado
