        ...
        <div class="navbar-nav-wrap-content-end">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    if (!array_key_exists($estadoActual, $estadoConfig)) $estadoActual = 'disponible';
                            ...
                            <div class="dropdown-item-text">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="card-text text-body" style="font-size: 0.85rem;">{{ $user->email ?? ''
                                            }}</p>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(function () {
        const ESTADOS = {
            disponible: { color: 'success', label: 'Disponible', hex: '#01C3A2' },
            ocupado: { color: 'danger', label: 'Ocupado', hex: '#E64A76' },
            ausente: { color: 'warning', label: 'Ausente', hex: '#F5CA99' },
            privado: { color: 'secondary', label: 'Privado', hex: '#6A7178' }
        };
        ...
        function updateEstadoUI(estado) {
            ...
            $legend.css({
                ...
                return 'background-color: ' + cfg.hex + ' !important; border-color: ' + cfg.hex + ' !important;';
            });
