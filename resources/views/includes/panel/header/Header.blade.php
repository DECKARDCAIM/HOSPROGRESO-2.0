<header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
        ...
        <div class="navbar-nav-wrap-content-start">
            ...
            @include('includes.panel.header.useroptions.Search')
        </div>
        <div class="navbar-nav-wrap-content-end">
            <ul class="navbar-nav">
                @include('includes.panel.header.useroptions.Notifications')
                <li class="nav-item">

                    <button class="btn btn-ghost-secondary btn-icon rounded-circle" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasChatISAAC" aria-controls="offcanvasChatISAAC">
                ...
                @include('includes.panel.header.useroptions.Avatar')
            </ul>
        </div>
    </div>
</header>