      ...
      <li class="step-item">
        <div class="step-content-wrapper">
          <div class="step-avatar">
            <img class="step-avatar" src="{{ asset('img/160x160/img9.jpg') }}" alt="Image Description">
          </div>
              ...
              <li class="list-group-item list-group-item-light">
                <div class="row gx-1">
                  <div class="col-6">
                    ...
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs" src="{{ asset('svg/brands/excel-icon.svg') }}"
                  ...
                  <div class="col-6">
                    ...
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs" src="{{ asset('svg/brands/word-icon.svg') }}"
                          alt="Image Description">
                      </div>
                      <div class="flex-grow-1 text-truncate ms-2">
                        <span class="d-block fs-6 text-dark text-truncate"
          ...
          <div class="step-content">
            ...
            <ul class="list-group list-group-sm">
              <li class="list-group-item list-group-item-light">
                <div class="row gx-1">
                  <div class="col">
                    <img class="img-fluid rounded" src="{{ asset('svg/components/card-1.svg') }}"
                      alt="Image Description">
                  </div>
                  <div class="col">
                    <img class="img-fluid rounded" src="{{ asset('svg/components/card-2.svg') }}"
                      alt="Image Description">
                  </div>
                  <div class="col">
                    <img class="img-fluid rounded" src="{{ asset('svg/components/card-3.svg') }}"
                      alt="Image Description">
                  </div>
      ...
      <div class="modal-body p-sm-5">
        <div class="text-center">
          <div class="w-75 w-sm-50 mx-auto mb-4">
            <img class="img-fluid" src="{{ asset('svg/illustrations/oc-collaboration.svg') }}" alt="Image Description"
              data-hs-theme-appearance="default">
            <img class="img-fluid" src="{{ asset('svg/illustrations-light/oc-collaboration.svg') }}"
        ...
        <div class="row">
          ...
          <div class="col-auto">
            <a class="d-flex align-items-center small text-body" href="#">
              <img class="avatar avatar-xss avatar-4x3 me-2" src="{{ asset('svg/brands/gmail-icon.svg') }}"
                alt="Image Description">
              Import contacts
            </a>
          </div>
