                ...
                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPacientes" class="nav-collapse collapse" data-bs-parent="#navbarVerticalMenu">
                            ...
                            <a class="nav-link" href="{{ route('maintenance.patient-relatives.index') }}"><i class="bi-people me-2"></i>Familiares</a>
                        </div>
                    </div>
                        ...
                        <div id="navbarVerticalMenuMantenimiento" class="nav-collapse collapse" data-bs-parent="#navbarVerticalMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navSubUbicaciones" class="nav-collapse collapse">
                                    <a class="nav-link" href="{{ route('maintenance.countries.index') }}"><i class="bi-globe me-2"></i>Países</a>
                                    <a class="nav-link" href="{{ route('maintenance.departments.index') }}"><i class="bi-map me-2"></i>Departamentos</a>
                                    <a class="nav-link" href="{{ route('maintenance.municipalities.index') }}"><i class="bi-geo me-2"></i>Municipios</a>
                                </div>
                            </div>
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navSubPaciente" class="nav-collapse collapse">
                                    <a class="nav-link" href="{{ route('maintenance.allergies.index') }}"><i class="bi-shield-exclamation me-2"></i>Alergias</a>
                                    <a class="nav-link" href="{{ route('maintenance.civil-statuses.index') }}"><i class="bi-person-badge me-2"></i>Estado Civil</a>
                                    <a class="nav-link" href="{{ route('maintenance.genders.index') }}"><i class="bi-gender-ambiguous me-2"></i>Género</a>
                                    <a class="nav-link" href="{{ route('maintenance.ethnicities.index') }}"><i class="bi-people me-2"></i>Etnia</a>
                                    <a class="nav-link" href="{{ route('maintenance.linguistic-communities.index') }}"><i class="bi-translate me-2"></i>Idiomas</a>
                                    <a class="nav-link" href="{{ route('maintenance.disabilities.index') }}"><i class="bi-universal-access me-2"></i>Discapacidad</a>
                                    <a class="nav-link" href="{{ route('maintenance.relationship-types.index') }}"><i class="bi-diagram-2 me-2"></i>Tipos Relación</a>
                                </div>
                            </div>
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navSubTrabajador" class="nav-collapse collapse">
                                    <a class="nav-link" href="{{ route('maintenance.schedules.index') }}"><i class="bi-clock me-2"></i>Turnos</a>
                                    <a class="nav-link" href="{{ route('maintenance.specialties.index') }}"><i class="bi-patch-check me-2"></i>Especialidades</a>
                                    <a class="nav-link" href="{{ route('maintenance.work-departments.index') }}"><i class="bi-building me-2"></i>Departamentos</a>
                                    <a class="nav-link" href="{{ route('maintenance.unity-executions.index') }}"><i class="bi-diagram-3 me-2"></i>Unidades</a>
                                    <a class="nav-link" href="{{ route('maintenance.roles.index') }}"><i class="bi-shield-lock me-2"></i>Roles</a>
                                </div>
                            </div>
