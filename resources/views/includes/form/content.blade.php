<div
    ...
    <div style="max-width: 23rem;">
        ...
        <div class="mb-5">
            <h2 class="display-12">Sistema de Gestión de Pacientes</h2>
        </div>

        <ul class="list-checked list-checked-lg list-checked-primary list-py-2">
            <li class="list-checked-item">
                <span class="d-block fw-semibold mb-1">Todo en uno</span>
                Gestiona pacientes, citas, Expedientes y más en un solo lugar.
            </li>

            <li class="list-checked-item">
                <span class="d-block fw-semibold mb-1">Facilitando los procesos medicos</span>
