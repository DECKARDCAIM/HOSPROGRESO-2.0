                        ...
                        <div id="addUserStepFormContent">
                            ...
                            <div id="addUserStepProfessional" class="card card-lg" style="display: none;">
                                ...
                                <div class="card-footer d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{ "targetSelector": "#addUserStepLocation" }'> Siguiente paso <i class="bi-chevron-right"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div id="addUserStepLocation" class="card card-lg" style="display: none;">
                                ...
                                <div class="card-footer d-flex align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <button type="button" class="btn btn-primary" data-hs-step-form-next-options='{ "targetSelector": "#addUserStepConfirmation" }'> Siguiente paso <i class="bi-chevron-right"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            <div id="addUserStepConfirmation" class="card card-lg" style="display: none;">
                                ...
                                <label class="avatar avatar-xxl avatar-circle avatar-border-lg profile-cover-avatar">
                                    <img id="confirmAvatarImg" class="avatar-img" src="{{ $user->avatar_url ?? asset('img/160x160/img1.jpg') }}" alt="Avatar">
                                </label>
                                <div class="card-body">
                                    <dl class="row">
