                                            ...
                                            <div class="d-flex align-items-center">
                                                <label class="avatar avatar-xl avatar-circle avatar-uploader me-5"
                                                    ...
                                                    <img id="avatarImg" class="avatar-img"
                                                        src="{{ $user->avatar_url ?? asset('dist/img/160x160/img1.jpg') }}"
                                                        alt="Avatar">
                                                    <input type="file" name="profile_photo"
                                                        ...
                                                        data-hs-file-attach-options='{ "textTarget": "#avatarImg", "mode": "image", "targetAttr": "src", "resetTarget": ".js-file-attach-reset-img", "resetImg": "{{ $user->avatar_url ?? asset('dist/img/160x160/img1.jpg') }}", "allowTypes": [".png", ".jpeg", ".jpg"] }'>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="text"
                                                    ...
                                                    name="first_name" id="firstNameLabel" autocomplete="off"
                                                    placeholder="Primer nombre"
                                                    value="{{ old('first_name', $user->first_name) }}">
                                                <input type="text"
                                                    class="form-control @error('second_name') is-invalid @enderror"
                                                    name="second_name" id="secondNameLabel" autocomplete="off"
                                                    placeholder="Segundo nombre"
                                                    value="{{ old('second_name', $user->second_name) }}">
                                                <input type="text"
                                                    class="form-control @error('third_name') is-invalid @enderror"
                                                    name="third_name" id="thirdNameLabel" autocomplete="off"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="text" class="form-control @error('cui') is-invalid @enderror"
                                                name="cui" id="cuiLabel" autocomplete="off" placeholder="CUI"
                                                value="{{ old('cui', $user->staff->cui ?? '') }}">
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label for="nitLabel" class="form-label">NIT</label>
                                            <input type="text" class="form-control @error('nit') is-invalid @enderror"
                                                name="nit" id="nitLabel" autocomplete="off" placeholder="NIT"
                                                value="{{ old('nit', $user->staff->nit ?? '') }}">
                                        </div>
                                        <div class="col-md-4 mb-2">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($civilStatuses ?? [] as $status)
                                                        <option value="{{ $status->id }}"
                                                            {{ old('civil_status_id', $user->staff->civil_status_id ?? '') == $status->id ? 'selected' : '' }}>
                                                            {{ $status->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="date"
                                                ...
                                                name="birth_date" id="birthDateLabel" autocomplete="off"
                                                value="{{ old('birth_date', isset($user->staff) && $user->staff->birth_date ? \Carbon\Carbon::parse($user->staff->birth_date)->format('Y-m-d') : '') }}">
                                        </div>
                                        <div class="col-md-4 mb-2">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($genders ?? [] as $gender)
                                                        <option value="{{ $gender->id }}"
                                                            {{ old('gender_id', $user->staff->gender_id ?? '') == $gender->id ? 'selected' : '' }}>
                                                            {{ $gender->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="text"
                                                ...
                                                id="phoneLabel" autocomplete="off" placeholder="Ej. +12345678"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <input type="email"
                                                ...
                                                id="emailLabel" autocomplete="off" placeholder="correo@ejemplo.com"
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($unityExecutions ?? [] as $unity)
                                                        <option value="{{ $unity->id }}"
                                                            {{ old('unity_execution_id', $user->staff->unity_execution_id ?? '') == $unity->id ? 'selected' : '' }}>
                                                            {{ $unity->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="tom-select-custom">
                                                <select
                                                    ...
                                                    @foreach ($workDepartments ?? [] as $wd)
                                                        <option value="{{ $wd->id }}"
                                                            {{ old('work_department_id', $user->staff->work_department_id ?? '') == $wd->id ? 'selected' : '' }}>
                                                            {{ $wd->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($specialties ?? [] as $specialty)
                                                        <option value="{{ $specialty->id }}"
                                                            {{ old('specialty_id', $user->staff->specialty_id ?? '') == $specialty->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <input type="text"
                                                ...
                                                name="collegiate_number" id="collegiateNumberLabel" autocomplete="off"
                                                placeholder="Número de colegiado"
                                                value="{{ old('collegiate_number', $user->staff->collegiate_number ?? '') }}">
                                        </div>
                                        <div class="col-sm-6 mb-2">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($schedules ?? [] as $schedule)
                                                        <option value="{{ $schedule->id }}"
                                                            {{ old('schedule_id', $user->staff->schedule_id ?? '') == $schedule->id ? 'selected' : '' }}>
                                            ...
                                            <div class="tom-select-custom">
                                                <select
                                                    ...
                                                    <option value="1"
                                                        ...
                                                        Activo – puede iniciar sesión</option>
                                                    <option value="0"
                                                        {{ old('is_active', $user->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>
                                                        Inactivo – no puede iniciar sesión</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($countries ?? [] as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ old('country_id', $user->staff && $user->staff->municipality && $user->staff->municipality->department ? $user->staff->municipality->department->country_id : '') == $country->id ? 'selected' : '' }}>
                                                            {{ $country->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($departments as $dept)
                                                        <option value="{{ $dept->id }}"
                                                            {{ old('department_id', $user->staff && $user->staff->municipality ? $user->staff->municipality->department_id : '') == $dept->id ? 'selected' : '' }}>
                                                            {{ $dept->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($municipalities as $muni)
                                                        <option value="{{ $muni->id }}"
                                                            {{ old('municipality_id', $user->staff->municipality_id ?? '') == $muni->id ? 'selected' : '' }}>
                                                            {{ $muni->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                name="address" id="addressLabel" autocomplete="off"
                                ...
                                <div class="card-footer d-sm-flex align-items-sm-center">
                                    ...
                                    <div class="ms-auto">
                                        <button id="addUserFinishBtn" type="button" class="btn btn-primary">
                                            <i class="bi-check-lg me-1"></i> Actualizar usuario
                                        </button>
                                    </div>
                                </div>
                            </div>
