    ...
    <main id="content" role="main" class="main">
        <div class="content container-fluid py-4">
            ...
            <form action="{{ route('releases.store') }}" method="POST" enctype="multipart/form-data" id="releaseForm">
                ...
                <input type="hidden" name="type" class="@error('type') is-invalid @enderror" id="type_hidden" value="{{ old('type', 'release') }}">
                <input type="hidden" name="status" class="@error('status') is-invalid @enderror" id="status_hidden" value="{{ old('status', 'published') }}">
                <div class="row">
                    <div class="col-lg-8 mb-4 mb-lg-0">
                        <div class="card mb-3 mb-lg-4">
                            <div class="card-body">
                                <label class="form-label">Título del Documento</label>
                                <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror" placeholder="Escribe el título..." value="{{ old('title') }}" required>
                            </div>
                        </div>
                        <div class="card mb-3 mb-lg-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var quill = new Quill('#editor', {
                theme: 'snow',
                placeholder: 'Comienza a redactar...',
