            ...
            <div class="row justify-content-lg-center">
                <div class="col-lg-10">
                    ...
                    <div class="text-center mb-5">
                        ...
                        @endphp
                        <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar" for="editAvatarUploaderModal" style="cursor: pointer; position: relative; border: none;">
                            @if ($user->profile_photo_path)
                                <img class="avatar-img" id="editAvatarImgModal" src="{{ asset('storage/' . $user->profile_photo_path) }}" alt="Foto de perfil">
                            @else
                                <span class="avatar-soft-primary" id="editAvatarInitials" style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%;">
                                    <span class="avatar-initials">{{ $iniciales }}</span>
                                </span>
                                <img class="avatar-img d-none" id="editAvatarImgModal" src="" alt="Previsualización de foto" onload="document.getElementById('editAvatarInitials').style.display='none'; this.classList.remove('d-none');">
                            @endif
                            <input type="file" class="js-file-attach avatar-uploader-input" id="editAvatarUploaderModal" name="profile_photo" form="profileForm" data-hs-file-attach-options='{"textTarget": "#editAvatarImgModal", "mode": "image", "targetAttr": "src", "allowTypes": [".png", ".jpeg", ".jpg"]}'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <form id="profileForm" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <small class="form-text text-muted">No puedes modificar el correo electrónico de esta cuenta.</small>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="cui" name="cui" maxlength="13" value="{{ old('cui', $user->cui) }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="nit">NIT</label>
                                                <input type="text" class="form-control" id="nit" name="nit" value="{{ old('nit', $user->nit) }}">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="tom-select-custom">
                                                    <select class="js-select form-select" id="gender" name="gender_id" data-hs-tom-select-options='{"placeholder": "Seleccione..."}'>
                            ...
                            <div class="card mb-3 mb-lg-5">
                                ...
                                <div class="card-body">
                                    <p class="card-text">Para actualizar tu contraseña, verifica tu contraseña actual y luego escribe la nueva.</p>
                                    <form id="passwordForm" method="POST" action="{{ route('profile.update') }}">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="update_password_only" value="1">
                                        <div class="row mb-3">
                                            <label for="current_password" class="col-sm-3 col-form-label form-label">Contraseña actual</label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" name="current_password" id="current_password" placeholder="Ingresa tu contraseña actual" aria-label="Contraseña actual">
                                        ...
                                        <div class="row mb-3">
                                            <label for="new_password" class="col-sm-3 col-form-label form-label">Nueva contraseña</label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" name="password" id="new_password" placeholder="Ingresa tu nueva contraseña" aria-label="Nueva contraseña">
                                                @error('password')
                                                    <span class="invalid-feedback d-block" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-4">
                                            <label for="password_confirmation" class="col-sm-3 col-form-label form-label">Verificar contraseña</label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Vuelve a escribir la nueva contraseña" aria-label="Confirmar contraseña">
                                            </div>
                                        </div>
