                ...
                <div class="text-center mb-5">
                    ...
                    <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar"
                        ...
                        <input type="file" class="js-file-attach avatar-uploader-input" id="editAvatarUploaderModal"
                            name="profile_photo" form="profileForm" data-hs-file-attach-options='{
                                ...
                                <form id="profileForm" method="POST" action="{{ route('profile.update') }}"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="cui" name="cui" maxlength="13"
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="marital_status" name="marital_status">
                                                <option value="" {{ old('marital_status', $user->marital_status) == '' ?
                                                    'selected' : '' }}>
                                                    Seleccione</option>
                                                <option value="soltero" {{ old('marital_status', $user->marital_status)
                                                    == 'soltero' ? 'selected' : '' }}>
                                                    Soltero/a</option>
                                                <option value="casado" {{ old('marital_status', $user->marital_status)
                                                    == 'casado' ? 'selected' : '' }}>
                                                    Casado/a</option>
                                                <option value="divorciado" {{ old('marital_status', $user->
                                                    marital_status) == 'divorciado' ? 'selected' : '' }}>
                                                    Divorciado/a</option>
                                                <option value="viudo" {{ old('marital_status', $user->marital_status) ==
                                                    'viudo' ? 'selected' : '' }}>
                                                    Viudo/a</option>
                                                <option value="union_libre" {{ old('marital_status', $user->
                                                    marital_status) == 'union_libre' ? 'selected' : '' }}>
                                                    Unión Libre</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control" id="gender" name="gender">
                                                <option value="" {{ old('gender', $user->gender) == '' ? 'selected' : ''
                                                    ...
                                                    Seleccione</option>
                                                <option value="masculino" {{ old('gender', $user->gender) == 'masculino'
                                                    ? 'selected' : '' }}>
                                                    Masculino</option>
                                                <option value="femenino" {{ old('gender', $user->gender) == 'femenino' ?
                                                    'selected' : '' }}>
                                                    Femenino</option>
                                            </select>
                                        </div>
