...
<main id="content" role="main" class="main">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card card-centered mb-3 mb-lg-5">
                            <div class="card-header card-header-content-between">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="projectReportDropdown">
                                        <span class="dropdown-header">Configuración</span>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#sessionHistoryModal">
                                            <i class="bi-clock-history dropdown-item-icon"></i> Ver registros
                                        </a>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#logoutOtherBrowserSessionsModal">
                            ...
                            <div class="card-body">
                                <p class="card-text text-start">Puedes cerrar sesión en todos tus otros dispositivos si lo deseas. A continuación se muestran tus sesiones Activas.</p>
                                @if (count($activeSessions) > 0)
                                <ul class="list-group list-group-flush list-group-no-gutters d-flex align-items-start text-start">
    ...
    <div class="modal fade" id="logoutOtherBrowserSessionsModal" tabindex="-1" aria-labelledby="logoutOtherBrowserSessionsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="logoutOtherBrowserSessionsModalLabel">Cerrar Otras Sesiones del Navegador</h5>
                ...
                <form action="{{ route('profile.sessions.destroy') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>Introduce tu contraseña para confirmar que deseas cerrar sesión en tus otros dispositivos en todos los navegadores.</p>
                        <div class="mb-3">
                            <label for="password" class="form-label">Contraseña</label>
                            <input type="password" class="form-control" id="password" name="password" required autocomplete="current-password" placeholder="Tu contraseña actual">
                            @error('password')
