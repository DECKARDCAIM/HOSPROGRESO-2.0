...
<main id="content" role="main" class="main"><div class="content container-fluid">
    <div class="page-header"><div class="row align-items-end">
        <div class="col-sm mb-2 mb-sm-0"><nav aria-label="breadcrumb"><ol class="breadcrumb breadcrumb-no-gutter">
            ...
            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('linguistic-communities.index') }}">Idiomas</a></li>
        ...
        <form action="{{ route('linguistic-communities.store') }}" method="POST" id="itemForm" class="needs-validation" novalidate>
            ...
            <div class="card card-lg mb-3 mb-lg-5">
                ...
                <div class="card-footer d-flex justify-content-end align-items-center gap-3">
                    <a href="{{ route('linguistic-communities.index') }}" class="btn btn-white">Cancelar</a>
