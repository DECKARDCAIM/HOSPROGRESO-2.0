                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="addUserStepFormContent">
                            <div id="addUserStepProfile" class="card card-lg active">
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <label class="col-sm-3 col-form-label form-label">Expediente Clínico <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top" title="El número de expediente clínico será generado automáticamente al guardar"></i></label>
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm-vertical">
                                                <input type="text" class="form-control bg-light" value="Generado automáticamente" readonly disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                            ...
                            <div id="addUserStepFamily" class="card card-lg" style="display: none;">
                                <div class="card-body">
                                    ...
                                    <div class="position-relative mb-4">
                                        ...
                                        <div id="relativeSearchResults" class="list-group position-absolute w-100 shadow-sm z-index-3" style="display:none; top:100%; z-index:999; max-height:220px; overflow-y:auto; background-color: var(--bs-card-bg); border: 1px solid var(--bs-border-color);">
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row g-2">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" id="newRelFirstName" placeholder="Primer nombre">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label form-label-sm">Segundo Nombre</label>
                                                    <input type="text" class="form-control form-control-sm" id="newRelSecondName" placeholder="Segundo nombre">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label form-label-sm">Primer Apellido *</label>
                                                    <input type="text" class="form-control form-control-sm" id="newRelFirstLastName" placeholder="Primer apellido">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label form-label-sm">Segundo Apellido</label>
                                                    <input type="text" class="form-control form-control-sm" id="newRelSecondLastName" placeholder="Segundo apellido">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label form-label-sm">Apellido de casada</label>
                                                    <input type="text" class="form-control form-control-sm" id="newRelMarriedLastName" placeholder="Apellido de casada">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label form-label-sm">DPI</label>
                                                    <input type="text" class="form-control form-control-sm js-input-mask" id="newRelDpi" placeholder="0000 00000 0000" data-hs-mask-options='{"mask": "0000 00000 0000"}'>
                                                </div>
                            ...
                            <div id="addUserStepConfirmation" class="card card-lg" style="display:none;">
                                ...
                                <div class="card-footer d-sm-flex align-items-sm-center">
                                    ...
                                    <div class="ms-auto">
                                        <button id="addUserFinishBtn" type="button" class="btn btn-primary" onclick="document.getElementById('addPatientForm').submit();">
