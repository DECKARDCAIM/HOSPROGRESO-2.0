                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-12">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="birthDateLabel" class="col-sm-6 col-form-label form-label">Fecha
                                                de
                                                nacimiento</label>
                                            <div class="col-sm-9">
                                ...
                                <div class="row mb-12">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="phoneLabel" class="col-sm-9 col-form-label form-label">Teléfono
                        ...
                        <div id="addUserStepBillingAddress" class="card card-lg" style="display: none;">
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select" name="department_id" id="departmentLabel" disabled>
                            ...
                            <div class="card-body">
                                ...
                                <div id="relativeCreateForm" class="card card-bordered border-primary mb-4"
                                    ...
                                    <div
                                        ...
                                        <span class="fw-semibold text-primary"><i class="bi-person-plus me-2"></i>Crear
                                            nuevo familiar</span>
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control form-control-sm js-input-mask"
                                                    id="newRelDpi" placeholder="0000 00000 0000"
                                                    data-hs-mask-options='{"mask": "0000 00000 0000"}'>
                                            </div>
