                                            ...
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <select name="status" id="filter_status"
                                                        ...
                                                        <option value="active"
                                                            {{ request('status') == 'active' ? 'selected' : '' }}>Activos
                                                        </option>
                                                    ...
                                                    <select name="linguistic_community_id"
                                                        ...
                                                        @foreach ($linguisticCommunities as $linguisticCommunity)
                                                            <option value="{{ $linguisticCommunity->id }}"
                                                                {{ request('linguistic_community_id') == $linguisticCommunity->id ? 'selected' : '' }}>
                                    ...
                                    <td class="table-column-pe-0">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="patientCheck{{ $patient->id }}"></label>
                                        </div>
                                    </td>
                                    <td class="table-column-ps-0">
                                        <a class="d-flex align-items-start"
                                            ...
                                            <div class="ms-3 flex-grow-1">
                                                <span
                                                    class="d-block h5 text-inherit mb-0">{{ $patient->full_name ?: 'Sin nombre' }}</span>
                                                <span
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            @else
                                                <a class="btn btn-white btn-sm"
                                                    href="{{ route('patients.edit', $patient) }}" title="Editar">
