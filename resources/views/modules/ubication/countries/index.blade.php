                ...
                <table id="datatable"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="d-block fs-5">{{ $country->description ?? '—' }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="{{ route('countries.destroy', $country->id) }}" method="POST"
                                        onsubmit="return confirm('¿Desactivar el país {{ addslashes($country->name) }}?')">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <form action="{{ route('countries.restore', $country->id) }}" method="POST"
                                        onsubmit="return confirm('¿Reactivar el país {{ addslashes($country->name) }}?')">
                                        @csrf
                        ...
                        <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                            ...
                            <div class="tom-select-custom">
                                <select id="datatableEntries"
                                    ...
                                    onchange="window.location.href = '{{ route('countries.index', request()->except(['per_page', 'page'])) }}' + (window.location.search.includes('?') ? '&' : '?') + 'per_page=' + this.value">
