...
@section('title', 'Crear Departamento de Trabajo')
@section('content')
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="nameLabel" placeholder="Ej. Recursos Humanos" value="{{ old('name') }}" required autocomplete="off">
                                </div>
                                @error('name')
