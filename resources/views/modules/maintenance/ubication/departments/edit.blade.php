...
@if ($errors->any())
        ...
        <div class="row justify-content-lg-center">
            ...
            <form action="{{ route('maintenance.departments.update', $department->id) }}" method="POST" id="departmentForm" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="card card-lg mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="nameLabel" placeholder="Ej. Guatemala" value="{{ old('name', $department->name) }}" required minlength="5" autocomplete="off">
                                @error('name')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
