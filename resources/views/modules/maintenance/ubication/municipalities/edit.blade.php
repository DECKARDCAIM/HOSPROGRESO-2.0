    ...
    <main id="content" role="main" class="main">
        ...
        <div class="page-header">
                <div class="row align-items-end">
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('maintenance.municipalities.index') }}">Municipios</a></li>
                    ...
                    <div class="col-auto">
                        <a href="{{ route('maintenance.municipalities.index') }}" class="btn btn-primary">
...
@if ($errors->any())
            ...
            <form action="{{ route('maintenance.municipalities.update', $municipality->id) }}" method="POST" id="municipalityForm" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="card card-lg mb-3 mb-lg-5">
                            ...
                            <div class="card-footer d-flex justify-content-end align-items-center gap-3">
                                <a href="{{ route('maintenance.municipalities.index') }}" class="btn btn-white">Cancelar</a>
