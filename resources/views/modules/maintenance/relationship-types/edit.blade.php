...
@section('title', 'Editar Tipo de Relación')
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Editar tipo de relación</h1>
                </div>
                <div class="col-auto">
...
@if ($errors->any())
        ...
        <div class="row justify-content-lg-center">
            ...
            <form action="{{ route('relationship-types.update', $relationshipType->id) }}" method="POST" id="mainForm" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="nameLabel" placeholder="Ej. Padre, Madre, Hermano" value="{{ old('name', $relationshipType->name) }}" required autocomplete="off">
                                </div>
                                @error('name')
