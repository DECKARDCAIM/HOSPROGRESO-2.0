        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <h1 class="page-header-title">Editar familiar</h1>
                </div>
                <div class="col-auto">
            ...
            <form action="{{ route('patient-relatives.update', $patientRelative->id) }}" method="POST" id="mainForm" class="needs-validation" novalidate>
                    ...
                    <div class="card card-lg mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="tom-select-custom">
                                        <select class="js-select form-select @error('patient_id') is-invalid @enderror" name="patient_id" id="patientLabel" required data-hs-tom-select-options='{"placeholder": "Seleccionar paciente...", "searchInDropdown": true}'>
                                            ...
                                            @foreach($patients as $patient)
                                                <option value="{{ $patient->id }}" {{ old('patient_id', $patientRelative->patient_id) == $patient->id ? 'selected' : '' }}>{{ $patient->first_name }} {{ $patient->first_last_name }} ({{ $patient->cui }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('patient_id')
                                    ...
                                    <div class="tom-select-custom">
                                        <select class="js-select form-select @error('relationship_type_id') is-invalid @enderror" name="relationship_type_id" id="relationshipLabel" required data-hs-tom-select-options='{"placeholder": "Seleccionar parentesco...", "hideSearch": true}'>
                                            ...
                                            @foreach($relationshipTypes as $type)
                                                <option value="{{ $type->id }}" {{ old('relationship_type_id', $patientRelative->relationship_type_id) == $type->id ? 'selected' : '' }}>{{ $type->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" id="firstNameLabel" placeholder="Ej. Juan" value="{{ old('first_name', $patientRelative->first_name) }}" required>
                                </div>
                                <div class="col-sm-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('first_last_name') is-invalid @enderror" name="first_last_name" id="firstLastLabel" placeholder="Ej. Pérez" value="{{ old('first_last_name', $patientRelative->first_last_name) }}" required>
                                </div>
                                <div class="col-sm-4 mb-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-4">
                                    ...
                                    <input type="text" class="form-control @error('cui') is-invalid @enderror" name="cui" id="cuiLabel" placeholder="13 dígitos" value="{{ old('cui', $patientRelative->cui) }}" required maxlength="13" minlength="13">
                                    @error('cui')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-footer d-flex justify-content-end align-items-center gap-3">
                            ...
                            <button type="submit" class="btn btn-primary">Actualizar Familiar</button>
                        </div>
                    </div>
                </form>
            </div>
