...
<main id="content" role="main" class="main"><div class="content container-fluid">
        ...
        </ol></nav><h1 class="page-header-title">Crear turno</h1></div>
...
@if ($errors->any())
    ...
    <div class="row justify-content-lg-center"><div class="col-lg-9">
            ...
            <form action="{{ route('maintenance.schedules.store') }}" method="POST" id="itemForm" class="needs-validation" novalidate>
            @csrf
            <div class="card card-lg mb-3 mb-lg-5">
                ...
                <div class="card-body"><div class="mb-4">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="nameLabel" placeholder="Ej. Turno matutino" value="{{ old('name') }}" required minlength="3" autocomplete="off">
                    </div>
