...
@section('content')
    <main id="content" role="main" class="main">
        ...
        <div class="content container-fluid">
            <!-- Step Form -->
            <form action="{{ route('users.store') }}" method="POST" class="js-step-form py-md-5"
                    ...
                    <div class="col-lg-8">
                        ...
                        <div id="addUserStepFormContent">
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="first_name" id="firstNameLabel" placeholder="Ej. Juan">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                            <label for="secondNameLabel" class="form-label">Segundo Nombre</label>
                                            <input type="text" class="form-control" name="second_name" id="secondNameLabel" placeholder="Ej. Carlos">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                            <label for="thirdNameLabel" class="form-label">Tercer Nombre</label>
                                            <input type="text" class="form-control" name="third_name" id="thirdNameLabel" placeholder="Ej. Luis">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="first_last_name" id="firstLastNameLabel" placeholder="Ej. Pérez">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                            <label for="secondLastNameLabel" class="form-label">Segundo Apellido</label>
                                            <input type="text" class="form-control" name="second_last_name" id="secondLastNameLabel" placeholder="Ej. Gómez">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                            <label for="marriedLastNameLabel" class="form-label">Apellido de Casada</label>
                                            <input type="text" class="form-control" name="married_last_name" id="marriedLastNameLabel" placeholder="Ej. de López">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="cui" id="cuiLabel" placeholder="CUI">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                            <label for="nitLabel" class="form-label">NIT</label>
                                            <input type="text" class="form-control" name="nit" id="nitLabel" placeholder="NIT">
                                        </div>
                                        <div class="col-sm-4 mb-2">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phoneLabel" placeholder="Ej. +12345678">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <input type="email" class="form-control" name="email" id="emailLabel" placeholder="correo@ejemplo.com">
                                        </div>
                                        <div class="col-sm-6 mb-2">
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-sm-12 mb-4">
                                            ...
                                            <select class="js-select form-select" name="role_id" id="roleIdLabel" data-hs-tom-select-options='{"searchInDropdown": false, "hideSearch": true}'>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <select class="js-select form-select" name="schedule_id" id="scheduleIdLabel" data-hs-tom-select-options='{"searchInDropdown": false, "hideSearch": true}'>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <input type="text" class="form-control" name="address" id="addressLabel" placeholder="Ej. 1ra Avenida 2-33 Zona 1">
                                        </div>
                                    </div>
                                </div>
                                <!-- Footer -->
                            ...
                            <div id="addUserStepConfirmation" class="card card-lg" style="display: none;">
                                <div class="card-body">
                                    <h3 class="card-title text-center mb-5">Por favor, confirma que la información es correcta antes de guardar.</h3>
