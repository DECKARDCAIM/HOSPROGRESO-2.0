                ...
                <div class="col-lg-6 d-flex justify-content-center align-items-center min-vh-lg-100">
                    <div class="w-100 content-space-t-4 content-space-t-lg-2 content-space-b-1" style="max-width: 25rem;">
                        <div id="login-form-wrapper">
                            ...
                            @endif
                            <form method="POST" action="{{ route('login') }}" role="form" class="text-start" novalidate autocomplete="off" onsubmit="if(window.showManualLoader) window.showManualLoader('Iniciando sesión...');">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                        <div class="text-center mb-4 d-lg-none">
                                            <a href="{{ route('home') }}">
                                                <img src="{{ asset('dist/img/Logotipo.svg') }}" alt="Logotipo" style="min-width: 20rem; max-width: 20rem;" data-hs-theme-appearance="default">
                                                <img src="{{ asset('dist/img/Logotipo-white.svg') }}" alt="Logotipo" style="min-width: 20rem; max-width: 20rem;" data-hs-theme-appearance="dark">
                                            </a>
                                        </div>
