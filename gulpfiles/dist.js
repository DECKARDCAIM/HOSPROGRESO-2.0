...
function copyFonts() {
    return gulp
      .src([
          paths.src.vendor.dir + '/bootstrap-icons/font/fonts/*'
      ], {
          allowEmpty: true
      })
...
gulp.task('dist', gulp.series(clean, CSS, minCSS, rtlCSS, minJS, vendorBundleJS, vendorBundleCSS, copyFonts, copyConfig, svgCompiler, copy, copyNode, copySkipedFiles, copyDependencies, copyFavicon));
